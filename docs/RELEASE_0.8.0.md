...
- Mostrar/ocultar Clave TuTop.
- Indicador simple de fortaleza de clave.
- Facultad explicada como personalización de comunidad.
- Verificación estudiantil expresamente separada y opcional.
