...
assert.match(androidAssets, /const labels = new Int32Array/);
assert.match(androidAssets, /keptComponentIds/);
assert.match(androidAssets, /Keep ONLY pixels belonging to the selected connected component/);
assert.match(androidAssets, /Buffer\.alloc\(cropWidth \* cropHeight \* 4, 255\)/);
