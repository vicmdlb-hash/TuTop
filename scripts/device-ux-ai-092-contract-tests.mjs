...
console.log('✅ TuTop 0.9.2 device contract: atomic registration/publication + Camera 8 photos + correct coarse-location fallback + real AI + one-shot staging reset + DD pin branding PASS');
