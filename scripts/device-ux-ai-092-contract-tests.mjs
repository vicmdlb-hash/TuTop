...
assert.doesNotMatch(appIcon, /linearGradient|feDropShadow|#211A47/i);
assert.doesNotMatch(adaptiveIcon, /linearGradient|feDropShadow|#211A47/i);
assert.match(splash092, /data-brand="tutop-dd-pin-splash"/);
assert.match(splash092, /aria-label="DD"/);
assert.doesNotMatch(splash092, /linearGradient|feDropShadow|#211A47|#090A10|#000000/i);
