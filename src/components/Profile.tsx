...
import { VALID_MEETING_POINTS } from '../lib/productAssistant';
...
export default function Profile() {
  ...
  const saveProductEdit = () => {
    ...
    updateProduct(editingProduct.id, {
      ...
      descripcion: editingProduct.descripcion?.trim().slice(0, 3000) || '',
