...
export default function UniversityNetworkSetup() {
  ...
  return <>
    <button onClick={begin} className="flex min-w-0 w-full items-center gap-2 rounded-2xl border border-violet-300/15 bg-[#111827]/95 px-3 py-2 text-left shadow-lg backdrop-blur" aria-label="Configurar universidad y campus">
