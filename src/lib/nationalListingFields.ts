...
const fields: Partial<Record<ProductCategory, NationalListingField[]>> = {
  ...
  'Cuartos & Renta': [
    ...
    { key: 'approximate_zone', label: 'Zona aproximada', placeholder: 'Ej. a 10 min de CU; nunca dirección exacta', required: true },
  ...
  'Transporte': [
    { key: 'origin_zone', label: 'Zona de salida', placeholder: 'Ej. Apizaco centro', required: true },
    { key: 'destination_zone', label: 'Destino', placeholder: 'Ej. UATx Ribereña', required: true },
